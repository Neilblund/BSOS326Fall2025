...
def get_county_data(year, census_key = None):
    '''
    ...
    census_params = {'get':'NAME,DP02_0001E,DP03_0087E,DP03_0002PE,DP02_0068PE,DP02_0066PE,DP05_0037PE',
                     'for':'county:*'}
    ...
    census_df['state'] = [i[1] for i in census_df.county.str.split(', ')]
    return census_df

def get_us_data(year, census_key = None):
    '''
